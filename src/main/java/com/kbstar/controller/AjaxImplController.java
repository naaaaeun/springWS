...
public class AjaxImplController {
    ...
    public Object markers(String loc){
        ...
        if(loc.equals("s")){
            ...
            list.add(new Marker(103,"담미온","http://www.naver.com", 35.1938469 ,  129.1536114,"a.jpg","b"));
            list.add(new Marker(104,"제주국수","http://www.naver.com", 35.1938469,   129.1536162,"b.jpg","b"));
            list.add(new Marker(105,"이층집","http://www.naver.com", 35.1938469 ,  129.1536172,"c.jpg","b"));
        }else if(loc.equals("j")){
            list.add(new Marker(106,"담미온","http://www.naver.com", 33.5104137,   126.4913544,"a.jpg","j"));
            list.add(new Marker(107,"제주국수","http://www.naver.com", 33.5104138,   126.4913734,"b.jpg","j"));
            list.add(new Marker(108,"이층집","http://www.naver.com", 33.5104139,   126.4913594,"c.jpg","j"));
        }
        JSONArray ja=new JSONArray();
        for(Marker obj:list){
            JSONObject jo=new JSONObject();
